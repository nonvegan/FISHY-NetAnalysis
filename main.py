...
fig.add_trace(go.Scatter(x=conn_df.index, y=conn_df["total_ip_bytes"], name="IP Total"))
fig.add_trace(go.Scatter(x=conn_df.index, y=conn_df["orig_ip_bytes"], name="IP Origin"))
fig.add_trace(go.Scatter(x=conn_df.index, y=conn_df["resp_ip_bytes"], name="IP Response"))
fig.for_each_trace(lambda trace: trace.update(mode="lines", hoverinfo="name+x+y"))
fig.show()
